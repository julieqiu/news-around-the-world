...
class YahooBoss(object):
    ...
    def __init__(self, **kwargs):
        self.key = 'dj0yJmk9UzhPZlRNbmFwQjdZJmQ9WVdrOWNXSlBRM2hOTm1VbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD1lNw--'
        self.secret = '8eb66129a2d550779614eb358f3f6bfecac854ef'
...
class BossSearch(YahooBoss):
    ...
    def __init__(self, **kwargs):
        super(BossSearch, self).__init__(**kwargs)
...
class PlaceFinder(YahooBoss):
    ...
    def __init__(self, **kwargs):
        super(PlaceFinder,self).__init__(**kwargs)
        self.params = {}
